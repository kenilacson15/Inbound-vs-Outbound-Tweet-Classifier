...
# Input Artifacts Directory (from feature engineering)
# INPUT_DIR = Path(r"C:\Users\Ken Ira Talingting\Desktop\Projects\twitter-customer_support-NLP\data\feature engineering")
INPUT_DIR = Path("C:/Users/Ken Ira Talingting/Desktop/Projects/twitter-customer_support-NLP/data/feature engineering")


# Output Directory for saving the trained model and results
# *** UPDATED OUTPUT DIRECTORY ***
OUTPUT_DIR = Path("C:/Users/Ken Ira Talingting/Desktop/Projects/twitter-customer_support-NLP/data/model_results")
...
SCALER_FILE = "numerical_scaler.joblib" # Loaded for completeness, not reapplied
VECTORIZER_FILE = "tfidf_vectorizer.joblib" # Loaded for completeness, not reapplied
